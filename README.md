...
* clean data
* show the first 5 columns and more for exit enter no 
...
tips: if you want enter 1
for new_york_city enter 2
for washington enter 3 
# Built with
 ...
 * [Yazn Altombkti]https://github.com/yzn23) 
